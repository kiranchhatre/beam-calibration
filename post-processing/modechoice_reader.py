...
Results_path = '/home/ubuntu/ksc_test/beam/output/sf-light'
...
print('\n'+subdirs[0][43:-29]+' 21 ITERS 8 Workers | Run @ '+ which_date +' | m5a.24xlarge [PLEASE NEGLECT THIS LINE]'+'\n')
...
print('Improvment in 7hrs 35 mins [PLEASE NEGLECT THE TIME]: ',improv ,'\n')
print('Info: 8 intercepts optimization at 0.0 value each reference simulation. [PLEASE NEGLECT THIS LINE]\n')
